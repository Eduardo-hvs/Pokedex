  ...
  <v-app>
    <v-container>
      <v-container>
       ...
       <h1 class="text-center white--text mb-8" style="font-size:5rem">Pokedex</h1>
      <v-text-field
        v-model="search"
        label="Pesquisar"
      ...
      <v-card v-if="selected_pokemon">
        ...
        <v-row class= "d-flex align-center">
         ...
         <v-col cols="8">
          ...
          <v-chip label><b>Altura:</b> {{selected_pokemon.height * 2.54}}cm</v-chip>
          <v-chip label class ="ml-2"><b>Peso:</b> {{(selected_pokemon.weight * 0.45359237).toFixed(0)}}kg</v-chip>
...
export default{
  ...
  // Se nenhum resultado for encontrado, você pode retornar um valor padrão ou null, dependendo do caso.
  return null;
},
